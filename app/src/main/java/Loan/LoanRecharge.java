...
public class LoanRecharge extends AppCompatActivity
        implements SheetBill.ConfirmInterface {

    final int REQUEST_CODE_BOARD = 100;
    final String INTENT_PUT_EXTRA = "Provider";
    int activity_layout = R.layout.activity_loan_recharge;
    TextView tv_boardHint, tv_boardName;
    TextInputLayout etl_mobileElec, etl_applicationNumber;
    TextInputEditText et_mobileElec, et_applicationNumber;
    Button btn_fetchBill;

    String mobileNumber, applicationNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loan_recharge);

        Toolbar toolbar = findViewById(R.id.toolbar);
        toolbar.setTitle("Pay Your Loan EMI");
    ...
    void initViews() {
        ...
        etl_applicationNumber = findViewById(R.id.etl_connectionNo);
        et_applicationNumber = findViewById(R.id.et_connectionNo);

        etl_applicationNumber.setVisibility(View.GONE);
        ...
        et_mobileElec.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (!isValidMobile(mobileNumber)) {
                    ...
                    etl_applicationNumber.setVisibility(View.VISIBLE);
                }

            }
        });

        applicationNumber = Objects.requireNonNull(et_applicationNumber.getText()).toString();

        et_applicationNumber.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
