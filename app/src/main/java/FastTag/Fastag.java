...
public class Fastag extends AppCompatActivity
    ...
    int activity_layout = R.layout.activity_fastag;
    TextView tv_boardHint, tv_boardName;
    TextInputLayout etl_mobileElec, etl_vehicleNo;
    TextInputEditText et_mobileElec, et_vehicleNo;
    Button btn_fetchBill;

    String mobileNumber, vehicleNo;
    ...
    void initViews() {
        ...
        etl_vehicleNo = findViewById(R.id.etl_connectionNo);
        et_vehicleNo = findViewById(R.id.et_connectionNo);

        etl_vehicleNo.setVisibility(View.GONE);
    ...
    void textWatcher() {
        ...
        et_mobileElec.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (!isValidMobile(mobileNumber)) {
                    ...
                    etl_vehicleNo.setVisibility(View.VISIBLE);
                }
        ...
        vehicleNo = Objects.requireNonNull(et_vehicleNo.getText()).toString();

        et_vehicleNo.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
