...
public class GasRecharge extends AppCompatActivity
        implements Gas.SheetBill.ConfirmInterface {

    final int REQUEST_CODE_BOARD = 100;
    final String INTENT_PUT_EXTRA = "Provider";
    int activity_layout = R.layout.activity_gas_recharge;
    TextView tv_boardHint, tv_boardName;
    TextInputLayout etl_mobileElec, etl_connectionNo;
    TextInputEditText et_mobileElec, et_connectionNo;
    Button btn_fetchBill;

    String mobileNumber, connectionNo;
    AlertDialog dialogView;

    Gas.SheetBill sheetClass;
    ...
    void initViews() {
        ...
        etl_connectionNo = findViewById(R.id.etl_connectionNo);
        et_connectionNo = findViewById(R.id.et_connectionNo);

        etl_connectionNo.setVisibility(View.GONE);
    ...
    void onBillReceived(OperatorModel tempModel) {
        sheetClass = new Gas.SheetBill(tempModel, this);
    ...
    void textWatcher() {
        ...
        et_mobileElec.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (!isValidMobile(mobileNumber)) {
                    ...
                    etl_connectionNo.setVisibility(View.VISIBLE);
                }
        ...
        connectionNo = Objects.requireNonNull(et_connectionNo.getText()).toString();

        et_connectionNo.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
