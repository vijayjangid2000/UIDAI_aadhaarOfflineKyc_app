...
public class ElecRecharge extends AppCompatActivity implements SheetBill.ConfirmInterface {

    final int REQUEST_CODE_BOARD = 100;
    final String INTENT_PUT_EXTRA = "Provider";
    TextView tv_boardHint, tv_boardName;
    TextInputLayout etl_mobileElec, etl_kNumber;
    TextInputEditText et_mobileElec, et_kNumber;
    Button btn_fetchBill;
    String mobileNumber, kNumber;
    AlertDialog dialogView;
    SheetBill sheetClass;
    OperatorModel operatorModel;
    UserData userData;
    private int activity_layout = R.layout.activity_electrivity_recharge_activity;
    ...
    void initViews() {
        ...
        etl_kNumber = findViewById(R.id.etl_connectionNo);
        et_kNumber = findViewById(R.id.et_connectionNo);

        etl_kNumber.setVisibility(View.GONE);
    ...
    void chooseBoard() {
        ...
        Intent intent = new Intent(ElecRecharge.this,
                Providers.class);
    ...
    void textWatcher() {
        ...
        mobileNumber = Objects.requireNonNull(et_mobileElec.getText()).toString().trim();
        ...
        et_mobileElec.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                mobileNumber = et_mobileElec.getText().toString().trim();

                if (!isValidMobile(mobileNumber)) {
                    etl_kNumber.setVisibility(View.GONE);
                    btn_fetchBill.setVisibility(View.GONE);
                } else {
                    etl_kNumber.setVisibility(View.VISIBLE);
                    etl_kNumber.requestFocus();
                }

            }
        });

        kNumber = Objects.requireNonNull(et_kNumber.getText()).toString();

        et_kNumber.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
